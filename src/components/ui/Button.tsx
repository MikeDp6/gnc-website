...
export function Button({ to, href, variant = 'blue', className, children, onClick }: { to?: string; href?: string; variant?: Variant; className?: string; children: React.ReactNode; onClick?: () => void }) {
