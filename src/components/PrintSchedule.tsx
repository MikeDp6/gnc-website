...
export function PrintSchedule({ tour }: { tour: Tournament }) {
  ...
  return (
    <div className="print-only">
      ...
      <div className="print-foot">Κανονισμοί: 4 παίκτες/ομάδα · μισό γήπεδο · μπάλα Νο6 · 10΄ ή πρώτος στους 21 · Οι ομάδες στο γήπεδο 10΄ πριν την ώρα τους. Αλλαγές ανακοινώνονται στη γραμματεία και στο gnc3on3.gr.</div>
    </div>
  )
}
