  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[2fr_1fr]">
      <div className="card grid gap-4 p-5 md:grid-cols-2">
        ...
        <label className="flex items-start gap-3 text-[14px] md:col-span-2"><input type="checkbox" checked={!!f.auto_approve} onChange={e => setF({ ...f, auto_approve: e.target.checked })} className="mt-1 h-4 w-4" />
          <span><b>Αυτόματη έγκριση δηλώσεων</b><span className="block text-[12px] text-mute">Οι δηλώσεις από το site μπαίνουν κατευθείαν «Ενεργές». Όταν μια κατηγορία γεμίσει (μέγιστο ομάδων), οι επόμενες πάνε στη λίστα αναμονής.</span></span></label>
