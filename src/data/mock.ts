...
export const tournaments: Tournament[] = [
  {
    ...
    categoryIds: categories.map(c => c.id), cover: '/img/gnc/hero-gnc-sunset.jpg',
  },
]
...
export const cities: City[] = [
  ...
  { id: 'rafina', name: 'Ραφήνα', nameEn: 'Rafina', lat: 38.02, lng: 24.01, image: '/img/gnc/gnc3on3_rafina-min.jpg', years: [2023], videos: [{"kind": "youtube", "id": "EA5vlAm5Lpw"}, {"kind": "instagram", "id": "CwU73UaO0r9"}] },
  { id: 'rethymno', name: 'Ρέθυμνο', nameEn: 'Rethymno', lat: 35.364, lng: 24.482, image: '/img/gnc/gnc3on3_rethymno-min.jpg' },
